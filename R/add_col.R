#' @title add_col
#' @description Function that adds new cols into a matrix/vector (depending the case). 
...
#' @param row_index Numeric index representing the col where the new line should be inserted.
#' @param new_object col or matrix to be inserted in the original one.
